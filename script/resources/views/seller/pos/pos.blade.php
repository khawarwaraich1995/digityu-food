...
@php
$currency_info=\App\Models\Option::where('key','currency_data')->first();
        $currency_value = json_decode($currency_info->value);
@endphp
...
<input type="hidden" id="currency_name" value="{{$currency_value->currency_icon ?? '$'}}" />
